...
function showContextMenu(x, y) {
    ...
    menu.innerHTML = `
        ...
        <div class="tonios-context-separator"></div>
        <div class="tonios-context-item" onclick="openApplication('properties')">
...
function openApplication(appName) {
    ...
    const applications = {
        ...
        wallpaper: {
            title: '🎨 Fond d\'écran',
            content: createWallpaperContent(),
            width: 500,
            height: 400
        },
        chat: {
        ...
        systemprops: {
            title: '🖥️ Propriétés système',
            content: createSystemPropsContent(),
            width: 600,
            height: 500
        }
    };
    ...
    if (!app) {
        showNotification(`Application "${appName}" introuvable`, 'error');
        return;
    }
    
    // Ouvrir la fenêtre avec le contenu de l'application
    openWindow(app.title, app.content, app.width, app.height);
}
